(function (global, factory) {
    ...
    core.watchModel("music.path", 
        function(oldMusic) {
            var newMusic = core.model.music.path;
            if(oldMusic) {
                stopMusic(oldMusic);
            }
    ...
    core.watchModel("music.volume", 
        function() {
            var newVolume = core.model.music.volume;
            if(typeof(newVolume) !== 'undefined') {
                if(core.model.music && isPlaying(core.model.music.path)) {
                    setVolume(core.model.music.path, newVolume);
                }
            }
        }
    );

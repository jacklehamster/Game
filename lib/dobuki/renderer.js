(function (global, factory) {
    ...
    function projectObject(object, index, geometry) {
        ...
        var objectCut = object.frame ? core.getCut(object.frame) : { cut:[0,0,0,0], texture:0 };
    ...
    function checkOnTime() {
        return core.loopTime()<frameTime/3;
    }
    ...
    function initialize() {
        ...
        core.addLoop(frameTime, [renderScene, calculateFPS, updateFromModel]);
        addFPSCounter();

        scene.add( getCoreMesh() );
  
        //  update background color
        core.watchModel("background.color", 
            function(newColor) {
                if(newColor) {
                    if(scene.background) {
        ...
        //  update browser tab's theme color
        core.watchModel("background.theme-color",
            function(newColor) {
...
//    core.spheres = [];
    ...
    */
    ...
    }).startAfter("initialize-renderer", "load-vertex-shader", "load-fragment-shader");

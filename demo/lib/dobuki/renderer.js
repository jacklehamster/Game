(function (global, factory) {
    ...
    function renderScene() {
        ...
        renderComponents.forEach(
            component => {
                if(component.objectRenderer.scene && component.objectRenderer.camera) {
                    renderer.render(component.objectRenderer.scene, component.objectRenderer.camera)
                }
            }
        );
    }
    ...
    function addRenderComponent(order, objectRenderer, preRenderCallback) {
...
//        return core.loopTime()<frameTime;
     ...
     *   PROCESSES
     */
    core.makeProcess("initialize-renderer", initialize).waitFor("page-loaded").ignoreParameters(true);

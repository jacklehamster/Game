...
(function (global, factory) {
     ...
     *  HEADER
     */
    core.requireScripts(['setup.js', 'spritesheet.js', 'utils.js', 'objectpool.js']);
    core.logScript();
    ...
    function createSpriteObject(x, y, z, width, height, quaternionArray, light, img) {
    ...
    function createMesh() {
        ...
        core.loadAsync([require.toUrl("vertex-shader.glsl"), require.toUrl("fragment-shader.glsl"), require.toUrl("vertex-shader-common.glsl")], function (vertexShader, fragmentShader, vertexShaderCommon) {

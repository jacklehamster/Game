...
(function (global, factory) {
    ...
    function spriteFace(spriteInfo) {
        ...
        return DOK.create(DOK.SpriteObject).init(x * cellSize, y * cellSize, size / 2, size, size, null, light, img);
    }
    ...
    function spriteCube(spriteInfo) {
        ...
        cube.faces.push(DOK.create(DOK.SpriteObject).init(x * cellSize, y * cellSize, size / 2, size, size, DOK.southQuaternionArray, light, img));
    ...
    function createSpriteCollection(options) {
        ...
        var spriteCollection = new DOK.Collection(options, spriteFunction, function (callback) {
